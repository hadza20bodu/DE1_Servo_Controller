...
HD_PWD='C:/Users/matys/DE1_Servo_Controller-main/PWM_Servo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_pwm_clk64kHz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source servo_pwm_clk64kHz.tcl -notrace
