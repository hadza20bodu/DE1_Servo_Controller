...
HD_PWD='C:/Users/matys/DE1_Servo_Controller-main/PWM_Servo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_pwm_clk64kHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servo_pwm_clk64kHz.tcl
